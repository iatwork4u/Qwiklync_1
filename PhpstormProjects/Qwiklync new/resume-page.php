...
<title> Qwiklync | Resume </title>

	<meta name="viewport" content="width=device-width"/>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<meta name="description" content="Qwiklync | Resume"/>
	<meta charset="UTF-8">
...
<div id="cv" class="instaFade">
	<div class="mainDetails">
		<div id="headshot" class="quickFade">
			<img src="resume_assets/headshot.jpg" alt="pic" />
		</div>
		...
		<div id="contactDetails" class="quickFade delayFour">
			<ul>
				<li>E-mail:: <a href="mailto:joe@google.com" target="_blank">abc@google.com</a></li>
				<li>Web site: <a href="http://www.google.com">www.google.com</a></li>
				<li>Linked In: <a href="http://www.linkedin.com">www.linkedin.com</a></li>
		...
		<section>
			...
			<div class="sectionContent">
				<article>
					<h2>College/University</h2>
					<p class="subDetails">Qualification</p>
					<!-- FOR INPUT FIELD WITH FIXED NO OF LINES -->
